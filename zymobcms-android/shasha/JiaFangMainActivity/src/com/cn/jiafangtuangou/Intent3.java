...
protected void onCreate(Bundle savedInstanceState) {
	...
	super.onCreate(savedInstanceState);
     ...
     tv.setText("\t"+"绿茶"+"\n"
    		        ...
    		        +"\t"+"清香四溢迷人醉" +"\n"
    		        +"\t"+"仿佛回到那最纯真的年代" );
fanhui=(Button) findViewById(R.id.fufan4);
fanhui.setOnClickListener(new OnClickListener() {

@Override
public void onClick(View v) {
	// TODO Auto-generated method stub
	Intent in=new Intent(Intent3.this, JiaFangMainActivity.class);
	startActivity(in);
//	finish();
}
});
 ...
 public void danjijianjie(View v){
		...
		switch (v.getId()) {
		case R.id.bt2:
			in=new Intent(Intent3.this, GongSiJianJie.class);
			startActivity(in);
//			finish();
			break;
		case R.id.bt3:
			in=new Intent(Intent3.this, ZaiXian.class);
			startActivity(in);
//			finish();
			break;
		case R.id.bt4:
			in=new Intent(Intent3.this, LianXiFangShi.class);
			startActivity(in);
//			finish();
			break;
		case R.id.bt5:
			in=new Intent(Intent3.this, Gengduo.class);
			startActivity(in);
//			finish();
			break;
		}
