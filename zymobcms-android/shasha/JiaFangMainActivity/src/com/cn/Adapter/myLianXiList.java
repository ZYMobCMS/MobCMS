...
public class myLianXiList extends BaseAdapter {
	ArrayList<HashMap<String, String>> arraylist = new ArrayList<HashMap<String,String>>();
	ArrayList<View> view = new ArrayList<View>();
	Context context;

	public  myLianXiList(ArrayList<HashMap<String, String>> arraylist, Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {
			...
			convertView=LayoutInflater.from(context).inflate(R.layout.lianxiitem, null);
