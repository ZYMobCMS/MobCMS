...
/**
 * This is the model class for table "zy_product_tab_type".
 *
 * The followings are the available columns in table 'zy_product_tab_type':
 * @property integer $id
 ...
 */
class ProductTabType extends RActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProductTabType the static model class
	 */
