...
class TabType extends RActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, create_user, status, create_time, category_id, icon, is_local_icon', 'required'),
			array('create_user, status, category_id, is_local_icon', 'numerical', 'integerOnly'=>true),
