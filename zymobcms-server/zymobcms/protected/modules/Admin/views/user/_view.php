<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('rigist_time')); ?>:</b>
	<?php echo CHtml::encode($data->rigist_time); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('login_days')); ?>:</b>
	<?php echo CHtml::encode($data->login_days); ?>
	<br />
