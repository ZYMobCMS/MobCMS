...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('tab_type_id')); ?>:</b>
	<?php echo CHtml::encode($data->tab_type_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('commentable')); ?>:</b>
