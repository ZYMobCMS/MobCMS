...
+ (void)animatedMoveView:(UIView *)view duration:(NSTimeInterval)duration newFrame:(CGRect)newFrame withStartSelector:(SEL)startSelector withStopSelector:(SEL)stopSelector withDelegate:(id)delegate
{
