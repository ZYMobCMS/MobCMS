...
- (NSURL *)urlWithRequestType:(ZYCMSRequestType)requestType
{
    ...
    switch (requestType) {
            ...
            case ZYCMSRequestTypeAdminLogin:
            urlString = ZYCMS_Admin_Login_Interface;
            break;
            
            case ZYCMSRequestTypeAdminSendIOSPush:
            urlString = ZYCMS_Admin_Send_Push_IOS_Interface;
            break;
...
- (NSString *)pulicParams
{
    ...
    [turl appendFormat:@"&appId=%@&userId=%@&adminLoginName=%@",APPID,[ZYAdminManager shareManager].adminId,[ZYAdminManager shareManager].adminLoginName];
